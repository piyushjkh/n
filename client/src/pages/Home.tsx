  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      <main className="pb-24">
        ...
        <section className="py-16 px-4 from-muted/30 to-background max-w-5xl mx-auto pt-[20px] pb-[20px] text-[16px] text-center bg-[#00000000] text-[#8c0707]">
          <h2 className="text-3xl md:text-4xl font-black mb-4 text-[#000000] pl-[0px] pr-[0px] ml-[20px] mr-[20px]">Course Quick Overview</h2>
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto text-center pt-[20px] pb-[20px]">
          ...
          <p className="text-xl mb-12 text-[#261818]">Making Lakhs Every Month💰</p>
        ...
        <section className="py-16 px-4 max-w-4xl mx-auto pt-[10px] pb-[10px] pl-[8px] pr-[8px] ml-[0px] mr-[0px] mt-[6px] mb-[6px]">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 rounded-xl hover:bg-muted/50 transition-colors border border-transparent hover:border-border pt-[6px] pb-[6px] mt-[8px] mb-[8px] pl-[1px] pr-[1px] text-[160px] text-[#ffffff] bg-[#000000]">
