        ...
        <section className="py-16 px-4 max-w-4xl mx-auto pt-[20px] pb-[20px] pl-[0px] pr-[0px] mt-[0px] mb-[0px] ml-[0px] mr-[0px]">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 rounded-xl hover:bg-muted/50 transition-colors border border-transparent hover:border-border pt-[6px] pb-[6px] mt-[8px] mb-[8px] pl-[1px] pr-[1px] text-[#ffffff] bg-[#000000]">
